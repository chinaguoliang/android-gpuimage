package jp.co.cyberagent.android.gpuimage.sample.glutils;
/*
...
public class GLDrawer2D {
	//===================================
	private static float toneLevel;
	private static float beautyLevel;
	private static float brightLevel;

	private static int paramsLocation;
	private static int brightnessLocation;
	private static int singleStepOffsetLocation;
	//=====================================
...
//			"}";
	...
	protected static void setFloatVec4(final int location, final float[] arrayValue) {
		GLES20.glUniform4fv(location, 1, FloatBuffer.wrap(arrayValue));
	}

	public static void setParams(float beauty, float tone) {
	...
	public static void setBrightLevel(float brightLevel) {
		GLDrawer2D.brightLevel = brightLevel;
		setFloat(brightnessLocation, 0.6f * (-0.5f + brightLevel));
	}

	protected static void setFloat(final int location, final float floatValue) {
